...
The package includes functions to measure the agreement of label transfer output with k-NN graph from full query dataset before preprocessing.

```{r}
pred.labels <- setNames(pred.labels.cca[,"predicted.id"], rownames(pred.labels.cca))
KNN_purity_dist(pbmc.atac.seu, pred.labels, reduction.name = "lsi
                ")
